            ...
            <div class="grid lg:grid-cols-2 gap-12">
                ...
                <div class="space-y-8">
                    ...
                    <div class="space-y-4">
                        ...
                        if ($calResult && $calResult->num_rows > 0):
                            while ($t = $calResult->fetch_assoc()):
                                ...
                                if ($t['status'] === 'ongoing') {
                                    ...
                                    $actionHtml = '<a href="tournaments.php" class="px-4 py-2 border ' . $btnClass . ' text-[10px] font-bold rounded-xl transition-all uppercase tracking-widest text-center">' . $btnText . '</a>';
                                    ...
                                    $actionHtml = '<span class="px-4 py-2 text-slate-400 text-[10px] font-bold uppercase tracking-widest">' . $statusLabel . '</span>';
                                }
                        ?>
                                <div class="flex items-center gap-6 p-5 bg-white dark:bg-slate-900/40 rounded-3xl border border-slate-100 dark:border-slate-800 hover:shadow-lg transition-all">
                                    <div class="flex flex-col items-center justify-center min-w-[60px] h-[60px] <?php echo $dateBg; ?> rounded-2xl">
                                        <span class="text-lg font-black leading-none"><?php echo $day; ?></span>
                                        <span class="text-[9px] font-black uppercase tracking-widest leading-none mt-1"><?php echo $month; ?></span>
                                    </div>
                                    <div class="flex-grow">
                                        <h4 class="font-bold text-sm uppercase tracking-tight text-slate-900 dark:text-white"><?php echo $title; ?></h4>
                                        <p class="text-xs text-slate-500 mt-0.5">
                                            <i class="far fa-clock mr-1 text-brandGreen"></i> <?php echo $time; ?> 
                                            &bull; 
                                            <i class="fas <?php echo $locIcon; ?> mr-1 text-brandGreen"></i> <?php echo $location; ?>
                                        </p>
                                    </div>
                                    <?php echo $actionHtml; ?>
                                </div>
                        ...
                        ?>
                            <div class="text-center py-10 bg-white dark:bg-slate-900/40 rounded-3xl border border-slate-100 dark:border-slate-800">
                    ...
                    <div class="lg:col-span-2">
                        ...
                        <div class="aspect-video rounded-[40px] overflow-hidden relative group">
                            ...
                            <div class="absolute inset-0 bg-gradient-to-t from-black via-transparent to-transparent p-10 flex flex-col justify-end">
                                ...
                                <a href="donate.php" class="self-start px-6 py-3 bg-white text-black text-[10px] font-black uppercase tracking-widest rounded-xl hover:bg-brandGreen/80 hover:scale-105 hover:text-white transition-all duration-300 text-center hover:shadow-lg hover:shadow-brandGreen/30">Support Initiative</a>
                            </div>
                        </div>
                    </div>
