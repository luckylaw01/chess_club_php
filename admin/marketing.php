        ...
        <div class="lg:col-span-2 space-y-8">
            <div class="bg-white dark:bg-slate-900 rounded-[32px] border border-slate-200 dark:border-slate-800 shadow-xl overflow-hidden glass p-8">
                ...
                <form action="marketing.php" method="POST" class="space-y-6">
                    ...
                    <div>
                        <label class="block text-xs font-black uppercase tracking-widest text-slate-400 mb-2">Campaign Content</label>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const form = document.getElementById('message-input')?.closest('form');
    if (form) {
        form.addEventListener('submit', (e) => {
            const html = quill.root.innerHTML;
            if (html === '<p><br></p>' || html.trim() === '') {
                alert('Campaign content cannot be empty.');
                e.preventDefault();
                return;
            }
