...
<div class="bg-white dark:bg-slate-900 rounded-[40px] border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden py-24">
    <div class="max-w-md mx-auto text-center">
        <div class="w-24 h-24 rounded-full bg-purple-500/10 text-purple-500 flex items-center justify-center text-4xl mx-auto mb-8 animate-bounce">
            <i class="fas fa-graduation-cap"></i>
        </div>
        <h2 class="text-3xl font-black uppercase tracking-tight mb-4">Coming Soon</h2>
        <p class="text-slate-500 font-medium mb-8">The Course Creator is currently in development. Soon you'll be able to package your chess wisdom into structured curricula.</p>
